...
| **RCE-2-WF** | 2 | Пятиканальный Wi-Fi удлинитель | [📁 Перейти](./RCE-2) |
...
| RCE-1-WF | RCE-2-WF |
|:---:|:---:|
| <sub>Одноканальный Wi-Fi удлинитель</sub> | <sub>Пятиканальный Wi-Fi удлинитель</sub> |
...
| 4 | **Полная изоляция** силовой и управляющей части для RCE-2-WF |
