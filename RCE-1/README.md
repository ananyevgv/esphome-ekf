...
Проект объединяет управление несколькими типами устройств в одном контроллере **EKF Wi-Fi PRO Connect RCE-1-WF**:
...
- **Плата базируется на:** EKF Wi-Fi PRO Connect RCE-1-WF
...
- ⚠️ Статус неисправности (нет воды / разделение воды)
