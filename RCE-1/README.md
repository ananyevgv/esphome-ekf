...
Назначение проекта
Умный контроллер для автоматизации оконных и климатических систем в помещении (Холл). Проект объединяет управление:
...
Розетками и фильтрацией (управление 5 реле)
...
Короткое нажатие (<0.5с): включение всех реле и подсветки
